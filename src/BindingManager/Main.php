...
use BindingManager\Listener\NotificationListener;
use BindingManager\Provider\DataProviderFactory;
use BindingManager\Provider\DataProviderInterface;
use BindingManager\Task\RequestTickTask;
...
class Main extends PluginBase {
    ...
    public function onEnable(): void {
        ...
        $this->getLogger()->info("BindingManager has been enabled.");
        $this->startPolling();
    }
